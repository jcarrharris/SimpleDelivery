IntercomRails.config do |config|
  # == Intercom app_id
  # 
  config.app_id = ENV["INTERCOM_APP_ID"] || "zb7tolcv"

  # == Intercom secret key 
  # This is required to enable secure mode, you can find it on your Intercom 
  # "security" configuration page.
  # 
  config.api_secret = "I0czWb93-zv9YRQKg_lc_r8zOtsC8iFSk8OeulWw"
  ...
  #
  config.api_key = "a0718b8183d56db972984684e7ec685e2e042b64"
